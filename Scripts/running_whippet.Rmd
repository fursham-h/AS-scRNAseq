...
for id in ${!whippetArray2[@]};do
	whippet-quant.jl <(cat ${whippetArray2[$id]}) -o whippet/quantify/${whippetNames2["$id"]} -x /media/emlab/RAID5/Genomes/GRCz10/Ensembl/whippet_index/graph.jls --biascorrect --sam > whippet_SAMs/${whippetNames2[$id]}.sam 
done
