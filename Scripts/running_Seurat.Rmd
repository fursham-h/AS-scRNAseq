...
mydata.markers <- FindAllMarkers(mydata, test.use = "negbinom", only.pos = TRUE, min.pct = 0.25, logfc.threshold = 0.25)
...
DimPlot(mydata, reduction = "tsne", group.by = "Age")
DimPlot(mydata, reduction = "tsne", group.by = "CellType")
```
